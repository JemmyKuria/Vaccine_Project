...
**Output**  
Saved preprocessed dataset as cleaned_vaccine_data.csv for consistent use.
...
_Error Note: Later cells incorrectly split y_train into y_train_h1n1 and y_train_seasonal, causing a ValueError in multi-output context. Corrected by maintaining y_train as a 2D DataFrame._
