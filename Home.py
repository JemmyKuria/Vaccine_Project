...
# Footer
st.markdown("""
<div style="margin-top: 5rem; padding: 1rem; text-align: center; color: #7f8c8d; border-top: 1px solid #ecf0f1;">
    <p>VaxPredict Vaccine Recommendation Engine • Public Health Tool</p>
</div>
""", unsafe_allow_html=True)